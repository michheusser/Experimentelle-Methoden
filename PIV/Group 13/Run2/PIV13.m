...
print(f1,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure1_run2','-dpng')
print(f2,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure2_run2','-dpng')
print(f3,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure3_run2','-dpng')
print(f4,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure4_run2','-dpng')
print(f5,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure5_run2','-dpng')
print(f6,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure6_run2','-dpng')
print(f7,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/sckaspar/Dropbox/Experimentelle Methoden/PIV/Report/pics/figure7_run2','-dpng')