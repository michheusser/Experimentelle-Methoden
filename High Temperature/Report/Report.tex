...
%---------------------------------------------------------------------------
 ...
 \title{Experimentelle Methoden für Ingenieuranwendungen}
\subtitle{Strahlungskorrigierte Temperaturmessungen
bei Temperaturen um 1000$^\circ$C}


\projecttype{Laborbericht}
...
\supervisionA{Philip Haueter}
%\supervisionB{Supervisor B}
%\supervisionC{Supervisor C}

\professorA{Prof. Aldo Steinfeld}
%\professorB{Prof. B}
%\professorC{Prof. C}
