...
% % plot temperature
% f1 = figure(1)
% set(f1,'Position', [0 0 500 1000])
% set(f1,'PaperPositionMode','auto')
% 
% s11 =subplot(2,1,1);
% plot(flow,T_1_650,flow,T_2_650,flow,T_g_650)
% set(s11,'Position',[0.056 0.6 0.9 0.35])
...
% set(s12,'Position',[0.056 0.05 0.9 0.35])
% xlabel('Volumenstrom [nl/min]','FontSize',14)
% ylabel('Temperatur [°C]','FontSize',14)
% grid on
% legend('T_1','T_2','T_{gas}')
...
% 
% print(f1,'/Network/Servers/mlh34-0.ethz.ch/Volumes/01_MXS_RAID/01_StudentData/boosfelm/Dropbox/experimentelle methoden/High Temperature/Report/pics/figure1','-dpng')
